	...
	<c:url value="/" var="contextPath" />
	  <meta charset="utf-8"/>
		...
		<link href="https://plus.googlecom/108540024862647200608"
			rel="publisher"/>
		<title>${produto.titulo} - Casa do Código</title><!-- 1 -->
...
<body class="produto"><!-- 2  -->
  ...
  <header id="layout-header">
		<div class="clearfix container">
			...
			<div id="header-content">
				<nav id="main-nav">
					...
					<ul class="clearfix">
						<li><a href="/cart" rel="nofollow">Carrinho (${carrinhoCompras.quantidade}) </a></li><!-- mudando /cart para /carrinho -->
						<!-- retornando  qtd de itens no carrinho -->
	...
	<article id="${produto.id}"><!-- 4 - para que seja usado o id do produto exibido.-->
		  <header id="product-highlight" class="clearfix">
		    <div id="product-overview" class="container">
		      ...
		      <h1 class="product-title">${produto.titulo}</h1><!-- 5 -->
	  ...
	  <!--  <form action="/carrinho/add" method="post" class="container"> esse tipo de endereco /carrinho/add perde o contexto da app (casadocodigo)-->
...
<section class="data product-detail">
    ...
    <p></p>
    <%-- <p>Data de publicação: ${produto.dataLancamento}</p> a data fica com formato estranho--%>
